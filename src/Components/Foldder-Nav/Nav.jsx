        ...
        <nav className={styles.nav} id={styles.nav}>
          ...
          <div className={styles.allInputBox} id={styles.allInputBox}>
            <div className={styles.inputDivNav} id={styles.inputDivNav}>
              <input
                className={styles.inputDivNav_input} id={styles.inputDivNav_input}
                type="text"
                placeholder="What are you looking for?"
              />
              <FontAwesomeIcon icon={faSearch} className={styles.searchIcon} id={styles.searchIcon} />
            </div>
            <div className={styles.HeartShoppingIcon} id={styles.HeartShoppingIcon}>
              <FontAwesomeIcon icon={faHeart} className={styles.HeartIcon} id={styles.HeartIcon} />
              <FontAwesomeIcon
                icon={faCartShopping}
                className={styles.ShoppinghIcon} id={styles.ShoppinghIcon}
              />
            </div>
          </div>
        </nav>
